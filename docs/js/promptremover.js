document.addEventListener("DOMContentLoaded", function(){
    ...
    for (let i = 0; i < collection.length; i++) {
        ...
        // read prompt string from an attribute of the code block:
        ...
        // attach updated command as an attribute to the button where clipboard.js will find it:
