...
The Operator currently allows doing logical cluster backups *on-demand* (i.e. manually at
...
file. This section contains the [backup.enabled](operator.md#backup-enabled) key (it should
